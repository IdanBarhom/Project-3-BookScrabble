...
public class MainTrain {
	...
	public static void testDM() {
		...
		if(!dm.challenge("t1.txt","t2.txt","t3.txt",t3[2]))
			System.out.println("problem for Dictionary Manager challenge 1  (-5)");
		if(dm.challenge("t2.txt","t3.txt","t1.txt","3"+t2[5]))
			System.out.println("problem for Dictionary Manager challenge 2 (-5)");
	...
	public static void main(String[] args) {
		if(testServer()) {
			//System.out.println("testServer working!");
			//testDM();
			testBSCH();
		}
